...
const translations = {
  'zh-CN': {
    ...
    sidebar: {
      new_chat: '新对话', new_task: '新建任务', collapse: '折叠侧边栏', no_conversations: '暂无任务，点击上方新建',
      no_match: '没有匹配的任务', no_messages: '暂无消息',
      im_status: '即时通讯连接状态', connected: '已连接', disconnected: '未连接',
      dashboard: '控制台', refresh: '刷新', open_home: '打开 Home 目录', open_home_ok: '已在文件管理器中打开', open_home_failed: '打开 Home 目录失败', open_logs: '打开日志目录', settings: '设置', skills: '技能', automation: '自动化', appearance: '外观', tasks: '任务列表', cron: '定时任务', cron_sessions: '定时会话', memory: '记忆',
      theme_dark: '深色', theme_light: '浅色', switch_to_dark: '切换为深色', switch_to_light: '切换为浅色',
    ...
    common: {
      loading: '加载中...', request_failed: '请求失败',
    },
    chat: {
      ...
      stop: '停止', send: '发送', start_chat: '开始对话吧',
      suggest_quantum: '什么是量子计算？', suggest_python: '写一个 Python 函数',
      suggest_ml: '机器学习类型', suggest_roadmap: '学习 Python 路线',
  ...
  'en': {
    ...
    sidebar: {
      new_chat: 'New Chat', new_task: 'New Task', collapse: 'Collapse sidebar', no_conversations: 'No tasks yet — create one above',
      no_match: 'No matching tasks', no_messages: 'No messages',
      im_status: 'IM Bridge connection status', connected: 'Connected', disconnected: 'Disconnected',
      dashboard: 'dashboard', refresh: 'Refresh', open_home: 'Open Home directory', open_home_ok: 'Opened in file explorer', open_home_failed: 'Failed to open Home directory', open_logs: 'Open Logs directory', settings: 'Settings', skills: 'Skills', automation: 'Automation', appearance: 'Appearance', tasks: 'Tasks', cron: 'Cron Jobs', cron_sessions: 'Cron Sessions', memory: 'Memory',
      theme_dark: 'Dark', theme_light: 'Light', switch_to_dark: 'Switch to Dark', switch_to_light: 'Switch to Light',
    ...
    common: {
      loading: 'Loading...', request_failed: 'Request failed',
    },
    chat: {
      ...
      call: 'call', step: 'Step', copy: 'Copy', message_placeholder: 'Type a message...',
      stop: 'Stop', send: 'Send', start_chat: 'Start chatting',
      suggest_quantum: 'What is quantum computing?', suggest_python: 'Write a Python function',
      suggest_ml: 'Types of machine learning', suggest_roadmap: 'Python learning path',
