...
| Conversation | 260-670 | 会话列表加载/切换/CRUD + 消息渲染（含 thinking 行） |
| Skills | 671-703 | 技能列表加载 |
| Views | 704-778 | 视图切换（欢迎页/新建任务/对话/面板） |
| Task composer | 779-990 | 新建任务页交互（附件/模型选择/发送） |
| Dropdowns | 991-1023 | 下拉菜单通用逻辑 |
| User menu / settings | 1024-1280 | 用户菜单 + 设置弹窗 + 模型编辑表单 |
| Events | 1281-1531 | 事件绑定（含上下文指示器悬浮事件） |
| Init | 1532-1548 | 初始化入口 |
| Hot Reload | 1549- | 前端热更新轮询 |
